...
public class CarResourceManager implements IResourceManager{
    ...
    @Override
    public ReservableItem reserveCar(int xid, int customerID, String location) throws RemoteException, InvalidTransactionException {
    ...
    public boolean shutdown() throws RemoteException {
        new Thread() {
            ...
            public void run() {
                ...
                System.out.println("Successfully shutdown the car server");
                System.exit(0);
            }
...
//            writeData(xid, customer.getKey(), customer);
	...
	@Override
	public String analyticsCar(int xid, int quantity) throws InvalidTransactionException {
