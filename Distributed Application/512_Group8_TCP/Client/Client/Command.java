...
public enum Command {
	...
	Bundle("Book N flight numbers, and optionally a room and/or car at a location", "<xid>,<CustomerID>,<FlightNumber1>...<FlightNumberN>,<Location>,<Car-1/0>,<Room-1/0>"),
	Summary("Show who has reserved an item and at what price", "<xid>"),
